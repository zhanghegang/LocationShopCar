...
public class CicleImage extends ImageView {
...
//        paint = new Paint();
    ...
    private void setCustomAttributes(AttributeSet attrs,Context context) {
        //RoundImageView是在attrs.xml中配置的<declare-styleable name="RoundImageView">
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.CicleImage);
        mBorderThickness = a.getDimensionPixelSize(R.styleable.CicleImage_border_thickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.CicleImage_border_outside_color,defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.CicleImage_border_inside_color, defaultColor);
    }
